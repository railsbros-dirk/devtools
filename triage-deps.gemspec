...
Gem::Specification.new do |gem|
  ...
  # metrics
  gem.add_dependency 'coveralls', '~> 0.7.0'
  gem.add_dependency 'flay',      '~> 2.4.0'
  gem.add_dependency 'flog',      '~> 4.2.0'
  gem.add_dependency 'reek',      '~> 1.3.2'
  gem.add_dependency 'rubocop',   '~> 0.14.1'
  ...
  # benachmarks
  gem.add_dependency 'rbench', '~> 0.2.3'

  # jruby
  gem.add_dependency 'jruby-openssl', '~> 0.8.5'
end
